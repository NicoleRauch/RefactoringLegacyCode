...
namespace Push
{
    public class PushingBalancesCalculator : BalancesOfMonthCalculator
    {
        ...
        public void FillData(IList<BalancesOfMonth> balancesOfMonthList)
        {
            ...
            {
                int ultimo = balancesOfMonth.Date.Day;

                double averageBalance = 0;
                int dayOfLatestBalance = 1;
                IList<Transaction> transactionsOfMonth = TransactionsOfMonth(balancesOfMonth.Date);
                ...
                balancesOfMonth.Balance = balance;
                balancesOfMonth.AverageBalance = (int)averageBalance;
            }
        }
