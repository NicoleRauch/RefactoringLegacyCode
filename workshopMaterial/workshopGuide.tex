...
\texttt{BalanceAndAverage.getBalance()} is modified

\texttt{BalanceAndAverage.getAverageBalance()} is modified
...
\texttt{BalanceAndAverage} (fields, setter and \texttt{calculate...} methods are removed)
