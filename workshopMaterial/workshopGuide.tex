...
\includegraphics[width=1\textwidth]{CompareViews/09_5-1.png}

\texttt{PullingBalancesCalculator} (uses the Months object)

\includegraphics[width=1\textwidth]{CompareViews/09_4-09_5-2.png}
...
\includegraphics[width=1\textwidth]{CompareViews/09_5-15-2.png}
