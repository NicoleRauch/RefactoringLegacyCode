...
class PushingBalancesCalculator
  ...
  def fill_data(balances_of_month_list)
    ...
    balances_of_month_list.each do |balances_of_month|
      ...
      balance = calculate_values_for_month(values_of_month, balance, date_of_month, transactions_of_month)
  ...
  def calculate_values_for_month(values_of_month, preceding_balance, date_of_month, transactions_of_month)
